<template>
  <div class="staticPage">
    <div class="container">
      ...
      <div class="text">
        <p>
          It is OnMyTeam.com’s policy to respect your privacy regarding any
          information we may collect while operating our website. This Privacy
          Policy applies to <a>https://onmyteam.com</a> (hereinafter, "us",
          "we", or "https://onmyteam.com"). We respect your privacy and are
        ...
        <p>
          Like most website operators, OnMyTeam.com collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. OnMyTeam.com’s purpose in collecting non-personally
          identifying information is to better understand how OnMyTeam.com’s
          visitors use its website. From time to time, OnMyTeam.com may release
          non-personally-identifying information in the aggregate, e.g., by
          publishing a report on trends in the usage of its website.
        </p>
        <p>
          OnMyTeam.com also collects potentially personally-identifying
          information like Internet Protocol (IP) addresses for logged in users
          and for users leaving comments on https://onmyteam.com posts.
          OnMyTeam.com only discloses logged in user and commenter IP addresses
          under the same circumstances that it uses and discloses
          personally-identifying information as described below.
        </p>
        <h2>Gathering of Personally-Identifying Information</h2>
        <p>
          Certain visitors to OnMyTeam.com’s websites choose to interact with
          OnMyTeam.com in ways that require OnMyTeam.com to gather
          personally-identifying information. The amount and type of information
          that OnMyTeam.com gathers depends on the nature of the interaction.
          For example, we ask visitors who sign up for an account at
          https://onmyteam.com to provide a username and email address.
        </p>
        <h2>Security</h2>
        <p>
        ...
        <p>
          OnMyTeam.com discloses potentially personally-identifying and
          personally-identifying information only to those of its employees,
          contractors and affiliated organizations that (i) need to know that
          information in order to process it on OnMyTeam.com’s behalf or to
          provide services available at OnMyTeam.com’s website, and (ii) that
          ...
          your home country; by using OnMyTeam.com’s website, you consent to the
          transfer of such information to them. OnMyTeam.com will not rent or
          ...
          affiliated organizations, as described above, OnMyTeam.com discloses
          ...
          governmental request, or when OnMyTeam.com believes in good faith that
          disclosure is reasonably necessary to protect the property or rights
          of OnMyTeam.com, third parties or the public at large.
        </p>
        <p>
          If you are a registered user of https://onmyteam.com and have supplied
          your email address, OnMyTeam.com may occasionally send you an email to
          tell you about new features, solicit your feedback, or just keep you
          up to date with what’s going on with OnMyTeam.com and our products. We
          ...
          OnMyTeam.com takes all measures reasonably necessary to protect
        ...
        <p>
          OnMyTeam.com may collect statistics about the behavior of visitors to
          its website. OnMyTeam.com may display this information publicly or
          provide it to others. However, OnMyTeam.com does not disclose your
          personally-identifying information.
        </p>
        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, OnMyTeam.com uses
        ...
        <p>
          ...
          website each time the visitor returns. OnMyTeam.com uses cookies to
          help OnMyTeam.com identify and track visitors, their usage of
          https://onmyteam.com, and their website access preferences.
          OnMyTeam.com visitors who do not wish to have cookies placed on their
          computers should set their browsers to refuse cookies before using
          OnMyTeam.com’s websites, with the drawback that certain features of
          OnMyTeam.com’s websites may not function properly without the aid of
          cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to OnMyTeam.com's use of
          cookies.
        </p>
        <h2>E-commerce</h2>
        <p>
          Those who engage in transactions with OnMyTeam.com – by purchasing
          OnMyTeam.com's services or products, are asked to provide additional
          ...
          OnMyTeam.com collects such information only insofar as is necessary or
          appropriate to fulfill the purpose of the visitor’s interaction with
          OnMyTeam.com. OnMyTeam.com does not disclose personally-identifying
        ...
        <p>
          Although most changes are likely to be minor, OnMyTeam.com may change
          its Privacy Policy from time to time, and in OnMyTeam.com’s sole
          discretion. OnMyTeam.com encourages visitors to frequently check this
