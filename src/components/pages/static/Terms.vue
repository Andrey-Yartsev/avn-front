    ...
    <div class="container">
      ...
      <div class="text">
        ...
        <p>
          ...
          use of OnMyTeam.com's Website.
        </p>
        <p>&nbsp;</p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions in full. Do not continue to use OnMyTeam.com's website if
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using OnMyTeam.com's website you
          consent to the use of cookies in accordance with OnMyTeam.com’s
          privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, OnMyTeam.com and/or it’s licensors own the
          intellectual property rights for all material on OnMyTeam.com. All
          intellectual property rights are reserved. You may view and/or print
          pages from https://onmyteam.com for your own personal use subject to
        ...
        <ol>
          ...
          <li>
            Reproduce, duplicate or copy material from https://onmyteam.com
          </li>
        </ol>
        <p>
          Redistribute content from OnMyTeam.com (unless content is specifically
        ...
        <ol>
          ...
          <li>
            ...
            ('Comments') in areas of the website. OnMyTeam.com does not screen,
            ...
            OnMyTeam.com, its agents or affiliates. Comments reflect the view
            and opinion of the person who posts such view or opinion. To the
            extent permitted by applicable laws OnMyTeam.com shall not be
          ...
          <li>
            OnMyTeam.com reserves the right to monitor all Comments and to
          ...
          <li>
            You hereby grant to <strong>OnMyTeam.com</strong> a non-exclusive
