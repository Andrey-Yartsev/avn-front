<template>
  <div class="staticPage">
    <div class="container">
      <h1>Terms of Use</h1>
      <div class="text">
        <h2>Welcome to OnMyTeam.com</h2>
        <p>These terms and conditions outline the rules and regulations for the use of OnMyTeam.com's Website.</p>
        <p>&nbsp;</p>
        <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use
          OnMyTeam.com's website if you do not accept all of the terms and conditions stated on this page.</p>
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
          ...
          the Company’s stated services/products, in accordance with and subject to, prevailing law of . Any use of the
        ...
        <h2>Cookies</h2>
        <p>We employ the use of cookies. By using OnMyTeam.com's website you consent to the use of cookies in accordance
          with OnMyTeam.com’s privacy policy.</p>
        <p>Most of the modern day interactive web sites use cookies to enable us to retrieve user details for each
          visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for
          those people visiting. Some of our affiliate / advertising partners may also use cookies.</p>
        <h2>License</h2>
        <p>Unless otherwise stated, OnMyTeam.com and/or it’s licensors own the intellectual property rights for all
          material on OnMyTeam.com. All intellectual property rights are reserved. You may view and/or print pages from
          https://onmyteam.com for your own personal use subject to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://onmyteam.com</li>
          <li>Sell, rent or sub-license material from https://onmyteam.com</li>
          <li>Reproduce, duplicate or copy material from https://onmyteam.com</li>
        </ol>
        <p>Redistribute content from OnMyTeam.com (unless content is specifically made for redistribution).</p>
        <h2>User Comments</h2>
        <ol>
          <li>This Agreement shall begin on the date hereof.</li>
          <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
            material and data ('Comments') in areas of the website. OnMyTeam.com does not screen, edit, publish or
            review Comments prior to their appearance on the website and Comments do not reflect the views or opinions
            of OnMyTeam.com, its agents or affiliates. Comments reflect the view and opinion of the person who posts
            such view or opinion. To the extent permitted by applicable laws OnMyTeam.com shall not be responsible or
            liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a
            result of any use of and/or posting of and/or appearance of the Comments on this website.
          </li>
          <li>OnMyTeam.com reserves the right to monitor all Comments and to remove any Comments which it considers in
            its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.
          </li>
          ...
          <li>You hereby grant to <strong>OnMyTeam.com</strong> a non-exclusive royalty-free license to use, reproduce,
