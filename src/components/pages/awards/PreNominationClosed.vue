<template>
  <div class="container">
    ...
    <div class="awards-title text-centered">
      Pre-nominations have closed
    </div>
    <div class="title-subtext text-centered">
      Voting for fan awards will begin Nov 27th. Make sure you come back to cast
      your vote for your favorite stars.
    </div>
  </div>
</template>
