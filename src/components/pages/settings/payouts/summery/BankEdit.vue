    ...
    <form class="payouts-bank-form" v-on:submit.stop.prevent="save">
      <div class="border-top shadow-block">
        <div class="container">
          ...
          >
            <div class="form-group-inner payments-system">
              <span class="payments-system__logo label">
                <svg
