          ...
          <div class="container">
            ...
            <div class="form-group form-group_with-label photo-form-group">
              ...
              >
                ...
                <input type="file" id="photo" accept=".jpg,.jpeg,.png" @change="addMediaFiles">
              </label>
            </div>
              ...
              <label class="form-group-inner">
                ...
                <div class="row">
                  <div class="col-form-lg">
                    ...
                    <div class="exp-row">
                      <input name="city" v-model="city" required id="input-city">
                    </div>
                  </div>
                  <div class="col-form-sm input-cvv-wrapper">
                    ...
                    <div class="postalCode-field">
                      <input name="postalCode" v-model="postalCode" required id="input-cvv">
                    </div>
                  </div>
                </div>
              </label>
              ...
              <label class="form-group-inner">
                ...
                <div class="checkbox-wrapper">
                  ...
                  <div class="input-desc payouts-desc">
                    I agree to
                    <router-link to="/terms" class="payouts-terms" target="_blank">Terms of Service</router-link>
                  </div>
                </div>
              </label>
            </div>
