  ...
  <div class="fl-height-content">
    ...
    <div class="boxes">
      ...
      <div class="container container_lg-width">
        <div class="row">
          <div class="unit-col unit-col_flex unit-col_justify-between unit-col_margin-center unit-col_mob-1 unit-col_desk-3 statistics-page-header">
        ...
        <div class="row">
          <div class="unit-col unit-col_mob-1 unit-col_desk-3">
            <div class="b-stat-info">
              <div class="b-stat-info__header">
                ...
                <div class="value-data">
                  ...
                  <div class="value-data__num line-1">
                    16
                  </div>
                </div>
              </div>
            ...
            <div class="b-stat-info">
              <div class="b-stat-info__header">
                ...
                <div class="value-data">
                  ...
                  <div class="value-data__num line-3">
                    48
                  </div>
                </div>
                <div class="value-data">
        ...
        <div class="row">
          ...
          <div class="unit-col unit-col_mob-1 unit-col_desk-6">
            <div class="b-stat-info">
              <div class="b-stat-info__header">
                <div class="value-data current">
                  <div class="value-data__name">
              ...
              <table class="table table_dotts-line ">
                ...
                <tbody>
                  <tr>
                    <td><span class="date-item">1 Nov</span></td>
                    <td class="line-1">$1000</td>
                    <td class="line-2">$100</td>
                    <td class="line-3">$10</td>
                    <td class="line-4">$30</td>
                    <td>$1140</td>
                  </tr>
                  <tr>
                    <td><span class="date-item">1 Oct</span></td>
                    <td class="line-1">$700</td>
                    <td class="line-2">$75</td>
                    <td class="line-3">$50</td>
                    <td class="line-4">$10</td>
                    <td>$835</td>
                  </tr>
                  <tr>
                    <td><span class="date-item">1 Sep</span></td>
                    <td class="line-1">$780</td>
                    <td class="line-2">$50</td>
                    <td class="line-3">$120</td>
                    <td class="line-4">$10</td>
                    <td>$960</td>
                  </tr>
                  <tr>
                    <td><span class="date-item">2 Aug</span></td>
                    <td class="line-1">$900</td>
                    <td class="line-2">$200</td>
                    <td class="line-3">$20</td>
                    <td class="line-4">$0</td>
                    <td>$1120</td>
                  </tr>
                  <tr>
                    <td><span class="date-item">1 Jul</span></td>
                    <td class="line-1">$1000</td>
                    <td class="line-2">$150</td>
                    <td class="line-3">$15</td>
                    <td class="line-4">$0</td>
                    <td>$1165</td>
                  </tr>
                </tbody>
        ...
        <div class="row">
          <div class="unit-col unit-col_mob-1 unit-col_desk-6">
            <div class="b-stat-info">
              ...
              <div class="graph-transcript">
                <div class="graph-view"></div>
                <div class="stat-country">
                  <ul class="stat-country-list">
                    <li class="stat-country-list__item">
                      <span class="stat-country__name">
                        United States
                      </span>
                      <span class="stat-country__value">
                        46
                      </span>
                    </li>
                    <li class="stat-country-list__item">
          ...
          <div class="unit-col unit-col_mob-1 unit-col_desk-3">
            <div class="b-stat-info">
              ...
              <div class="bests-users">
                <ul class="list-bests-users">
                  <li class="list-bests-users__item">
                    <a class="avatar avatar_gap-r-sm avatar_sm" href="#">
                      <span class="avatar__img"></span>
                    </a>
                    <a class="name" href="#">Cat Space</a>
